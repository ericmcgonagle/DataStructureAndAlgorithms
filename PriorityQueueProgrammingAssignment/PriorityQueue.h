...
private:
    ...
    void downheap(size_type index)
    {
        ...
        size_type promoteChild;
        if (right_child(index) < size())
        {
            if (comp(c.at(left_child(index)), c.at(right_child(index))))
                promoteChild = right_child(index);
            else
                promoteChild = left_child(index);
        }
        else
        {
            promoteChild = left_child(index);
        ...
        if (comp(c.at(index), c.at(promoteChild)))
        {
            std::swap(c.at(index), c.at(promoteChild));
        }

        downheap(promoteChild);
    }
